...
if __name__ == "__main__":
    ...
    for epoch in range(num_epochs):
        ...
        if True:  # save checkpoint
            ...
            torch.save(ssd_model.state_dict(), f"SSD_checkpoints/SSD_weights_checkpoint_{int(epoch + 1)}.pth")
            np.savetxt("SSD_stats/train_loss_arr.txt", train_loss_arr)
            np.savetxt("SSD_stats/val_loss_arr.txt", val_loss_arr)